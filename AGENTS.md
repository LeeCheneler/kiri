...
`AGENTS.md` is the source of truth for this repository's instructions.
`CLAUDE.md` imports it for Claude Code. For workflow authoring in a Kiri
workspace, read [the authoring reference](docs/workflow-authoring.md).

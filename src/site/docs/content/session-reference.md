...
Tools, instructions, permissions, and execution details. For everyday use,
start with [Have a conversation](/docs/sessions).
...
A turn can take up to **128 work steps**, each a model response that may
...
answer on step 128 completes normally. Tool approvals still pause for your

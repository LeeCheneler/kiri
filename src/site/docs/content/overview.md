...
- **Tools** — sessions call tools from MCP servers you declare in `kiri.yaml`
  (web search, and more), plus a built-in **investigate** tool that delegates
  research to a sub-session and reports back just the findings.

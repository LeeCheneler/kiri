    ...
    it("lists each server's tools with their standing permission", async () => {
      ...
      expect(await res.json()).toEqual({
        ...
        builtin: [
          ...
          { name: "worktree_list", description: expect.any(String), permission: "allow" },
          { name: "worktree_create", description: expect.any(String), permission: "ask" },
          { name: "worktree_remove", description: expect.any(String), permission: "ask" },
          { name: "worktree_prune", description: expect.any(String), permission: "ask" },
        ],
      });
    });
  });

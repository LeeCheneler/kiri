    ...
    it("lists each server's tools with their standing permission", async () => {
      ...
      expect(await res.json()).toEqual({
        ...
        builtin: [
          ...
          { name: "delete_article", description: expect.any(String), permission: "allow" },
          ...
          { name: "use_skill", description: expect.any(String), permission: "allow" },
          ...
          { name: "list_tasks", description: expect.any(String), permission: "allow" },
          { name: "add_task", description: expect.any(String), permission: "allow" },
          { name: "update_task", description: expect.any(String), permission: "allow" },
          { name: "delete_task", description: expect.any(String), permission: "ask" },
          { name: "create_task_group", description: expect.any(String), permission: "allow" },
          { name: "update_task_group", description: expect.any(String), permission: "allow" },
          { name: "delete_task_group", description: expect.any(String), permission: "ask" },
          ...
          { name: "set_working_directory", description: expect.any(String), permission: "allow" },
          { name: "write_file", description: expect.any(String), permission: "ask" },
          { name: "edit_file", description: expect.any(String), permission: "ask" },
          ...
          { name: "send_to_delegate", description: expect.any(String), permission: "allow" },

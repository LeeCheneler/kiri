...
function buildEffortGuidance(effort: Effort): string {
  const calibration: Record<Effort, string> = {
    ...
    max: "Be exhaustively thorough: depth has been chosen over speed here, so reason every step through fully and verify conclusions before presenting them.",
  };

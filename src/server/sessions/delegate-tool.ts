      ...
      [DELEGATE_TOOL_NAME]: tool({
        ...
        inputSchema: z.object({
          ...
          model: z
            ...
            .describe(
              "The size of model the worker runs: tanto for quick mechanical legwork, katana as the default working blade, odachi for deep synthesis and the hardest problems.",
            ),
        }),
